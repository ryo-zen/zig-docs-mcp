...
```
Shell$ zig build-exe values.zig
$ ./values
1 + 1 = 2
7.0 / 3.0 = 2.3333333
false
...
```
Shell$ zig build-exe string_literals.zig
$ ./string_literals
*const [5:0]u8
5
e
...
```
Shell$ zig build-exe constant_identifier_cannot_change.zig
...
```
Shell$ zig build-exe mutable_var.zig
$ ./mutable_var
5679
...
```
Shell$ zig build-exe assign_undefined.zig
$ ./assign_undefined
1
...
```
Shell$ zig build-exe destructuring_to_existing.zig
...
```
Shell$ zig build-exe destructuring_mixed.zig
$ ./destructuring_mixed
x = 1, y = 2, z = 3
x = 2
