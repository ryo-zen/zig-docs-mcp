...
```
Shell$ zig test test_call_builtin.zig
...
```
Shell$ zig test test_compileLog_builtin.zig
...
```
Shell$ zig test test_field_builtin.zig
...
```
Shell$ zig test test_hasDecl_builtin.zig
...
```
Shell$ zig test test_intCast_builtin.zig
...
```
Shell$ zig test test_wasmMemoryGrow_builtin.zig
...
```
Shell$ zig test test_setEvalBranchQuota_builtin.zig
...
```
Shell$ zig test test_shuffle_builtin.zig
...
```
Shell$ zig test test_splat_builtin.zig
...
```
Shell$ zig test test_reduce_builtin.zig
...
```
Shell$ zig test test_src_builtin.zig
...
```
Shell$ zig test test_round_builtin.zig
...
```
Shell$ zig test test_this_builtin.zig
...
```
Shell$ zig test test_truncate_builtin.zig
...
```
Shell$ zig test test_TypeOf_builtin.zig
