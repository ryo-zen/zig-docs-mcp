...
📚 **Runnable examples:** `zig_docs_std/Examples/test_reader_comprehensive.zig`, `zig_docs_std/Examples/test_reader_peek_vs_take.zig`, `zig_docs_std/Examples/test_reader_delimiter.zig`
